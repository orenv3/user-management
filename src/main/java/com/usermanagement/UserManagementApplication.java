	...
	CommandLineRunner commandLineRunner(AuthenticationService service, TaskService srv){
		return args -> {
				...
				CreateUserRequest createAdmin =
						new CreateUserRequest("oren", "orenv@vino.com",
								true, true, "1234");
				...
				new CreateUserRequest("admin", "admin@gvino.com",
						true, true, "1234");
			...
			log.info("Seed task1: {}", srv.createTask(task1));
			log.info("Seed task2: {}", srv.createTask(task2));
			log.info("Seed task3: {}", srv.createTask(task3));
			log.info("Seed task4: {}", srv.createTask(task4));
